...
class IMUVisualizer(Node):
    def __init__(self):
        ...
        self.align_subscriber = self.create_subscription(
            String,
            '/obstacle_direction',
            self.obstacle_direction_callback,
            10
        )
        self.align_subscriber = self.create_subscription(
            Twist,
        ...
        self.dt = 0.1
        self.gyro_drift_threshold = 0.05
        self.gyro_drift_threshold_obstacle = 0.1
        ...
        try:
            while rclpy.ok():
                ...
                if gyro_data and accel_data:
                    ...
                    obstacle_pitch_value = alpha * prev_pitch + (1-alpha_obstacle) * obstacle_pitch_deg

                    msg = Float32()
                    msg.data = obstacle_pitch_value
                    ...
                    obstacle_pitch_text = self.font.render(f"Obstacle Pitch: {obstacle_pitch_value:.2f}°", True, (255, 255, 255))
