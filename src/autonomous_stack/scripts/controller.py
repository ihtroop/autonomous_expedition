...
#         else:
#             self.obstacle_detected = False
#             self.get_logger().info("No front obstacle detected")
...
#             self.get_logger().info("Alignment in progress, ignore dir.")
#             return
...
#         else:
#             self.get_logger().info("Ignoring straight path correction - other operation in progress")
...
#             # Keep the velocities set by align_callback
...
#                 #     if self.obstacle_direction == "Front_left" :                   
#                 #             self.linear_velocity = 0.0
