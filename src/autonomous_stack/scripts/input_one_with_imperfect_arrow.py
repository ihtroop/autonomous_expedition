...
class DirectionPublisher(Node):
    def __init__(self):
        ...
        self.align_dist_ll = 71
        self.align_dist_ul = 650
    ...
    def control_turtlebot(self, contour, relative_position, distance):
        ...
        if self.align_dist_ll < distance < self.align_dist_ul:
    ...
    # Rest of the processing logic from send_cmd_vel
        ...
        for contour in contours:
            ...
            if cv2.contourArea(contour) < 450:  # Adjust threshold if needed
                continue
            ...
            if len(approx) == 7:
                ...
                if (
                    ...
                    355<=base_angle1+base_angle2+head_angle1+head_angle2<=480
