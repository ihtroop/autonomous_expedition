...
class Controller(Node):
    def __init__(self):
        ...
        self.straightpathturnleft = 0.63
        self.straightpathturnright = -0.63
        self.turnleft = 0.63
        self.turnright = -0.63
        ...
        # obstacle aviodance cmd_vel
        self.obstacle_avoidance_cmd_vel = self.create_subscription(
            Twist, "/obstacle_avoidance_cmd_vel", self.obs_cmd_vel_callback, 10
        )
    ...
    def obs_cmd_vel_callback(self, msg):
        self.linear_velocity = msg.linear.x
        self.angular_velocity = msg.angular.z
